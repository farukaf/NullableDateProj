...
namespace App1.Controls
{
    public class CurrencyConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return NumberHelper.CurrencyConverter(thedecimal);
        }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            decimal decValue = 0;
            (decValue, strValue) = NumberHelper.CurrencyConverter(strValue);
        ...
        private void Unfocused_Event(object sender, FocusEventArgs e)
        {
            ...
            if (sender is Entry entry)
            {
                ...
                if (entry.BindingContext is IConverterEvents converterEvents)
                {
                    _ = converterEvents.UnfocusEvent();
                }
            }
        }
    }
